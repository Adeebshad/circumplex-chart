...
class CircumplexChartPlugin extends _core.ChartPlugin {
  ...
  constructor() {
    ...
    super({
      ...
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../CircumplexChart'))),
      metadata,
      transformProps: _transformProps.default
    });
  }
}
exports.default = CircumplexChartPlugin;